...
export default function Footer() {
    return (
      <footer className="px-4 divide-y bg-gradient-to-b from-white to-green-100 rounded-lg mt-10 w-full">
	<div className="container flex flex-col justify-between py-10 mx-auto space-y-8 lg:flex-row lg:space-y-0">
		...
		<div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
			...
			<div className="space-y-3">
				<h3 className="tracking-wide uppercase dark:text-coolGray-50 font-semibold text-lg">Company</h3>
				<ul className="space-y-1">
					<li>
						<a rel="noopener noreferrer" href="#" className='font-medidum hover:text-green-500'>Privacy</a>
					</li>
					<li>
						<a rel="noopener noreferrer" href="#" className='font-medidum hover:text-green-500'>Terms of Service</a>
					</li>
				</ul>
			</div>
			<div className="space-y-3">
			...
			<div className="space-y-3">
				<div className="uppercase dark:text-coolGray-50 font-semibold text-lg">Social media</div>
				<div className="flex justify-start space-x-3">
					<a rel="noopener noreferrer" href="#" title="Facebook" className="flex items-center p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110">
						<svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 32 32" className="w-5 h-5 fill-current">
							<path d="M32 16c0-8.839-7.167-16-16-16-8.839 0-16 7.161-16 16 0 7.984 5.849 14.604 13.5 15.803v-11.177h-4.063v-4.625h4.063v-3.527c0-4.009 2.385-6.223 6.041-6.223 1.751 0 3.584 0.312 3.584 0.312v3.937h-2.021c-1.984 0-2.604 1.235-2.604 2.5v3h4.437l-0.713 4.625h-3.724v11.177c7.645-1.199 13.5-7.819 13.5-15.803z"></path>
						</svg>
					</a>
					<a rel="noopener noreferrer" href="#" title="Twitter" className="flex items-center p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110 ">
					...
					<a rel="noopener noreferrer" href="#" title="Instagram" className="flex items-center p-1 shadow-lg rounded-lg transition ease-in-out hover:-translate-y-1 hover:scale-110">
	...
	<div className="py-6 text-sm text-center dark:text-coolGray-400">© 2023 Company Co. All rights reserved.</div>
</footer>
    );
}
